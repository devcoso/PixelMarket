...
<div class="py-10 text-zinc-600 space-y-5 min-h-screen flex items-center flex-col">
    ...
    <p class="text-2xl font-bold text-zinc-800 "><?php echo $usuario->nombre . " " . $usuario->apellido?></p>
    <p class="text-2xl font-bold text-zinc-700 "><?php echo $usuario->email ?></p>
    <img src="https://www.gravatar.com/avatar/<?php echo md5(strtolower(trim($usuario->email))); ?>?d=retro&f=y&s=256" alt="">
    <p class="text-xl font-bold">Saldo: <span class="text-zinc-800 ">$<?php echo  number_format($usuario->saldo, 2, '.', ','); ?></span></p>
