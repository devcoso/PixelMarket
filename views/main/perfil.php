<?php 
    if(is_auth()) { ?>
        <div class="py-10 text-zinc-600 space-y-5 min-h-screen flex justify-center items-center flex-col">
            <h1 class="text-4xl font-bold text-zinc-800 ">Perfil</h1>
    ...
    <?php } else { ?>
        <div class="py-10 text-zinc-800 space-y-5 min-h-screen flex justify-center items-center flex-col">
            ...
            <p class="text-lg text-center">Debes iniciar sesión para ver tu comprar o crea una cuenta si aún no la tienes</p>
