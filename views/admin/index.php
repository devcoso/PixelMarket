<div class="w-full md:w-3/4 lg:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-3 m-auto">
    <div class="py-8 space-y-8 bg-zinc-200 text-center text-3xl text-zinc-800">
...
<div class="w-full md:w-3/4 lg:w-2/3 my-10 m-auto">
    <h3 class="text-3xl font-display text-center text-zinc-700">Categorias más vendidos</h3>
