<div class="py-10 text-zinc-600 space-y-5 min-h-screen flex items-center flex-col w-full mb-5">
    <div class="flex w-full p-3">
        <a href="/admin/compras" class="rounded-md shadow-md font-display bg-zinc-800 text-white bloc px-5 py-2">&laquo;Volver</a>
    </div>
    ...
    <div class="space-y-6 w-full lg:w-1/2 mx-6">
        ...
        <div class="text-center">
            ...
            <p class="font-display"><?php echo $usuario->nombre . ' ' . $usuario->apellido?></p>
            <p class="font-display"><?php echo $usuario->email?></p>
            <img src="https://www.gravatar.com/avatar/<?php echo md5(strtolower(trim($usuario->email))); ?>?d=retro&f=y&s=50" class="m-auto" alt="Imagen de perfil de <?= $usuario->email ?>">
        </div>
    </div>
</div>